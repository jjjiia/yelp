...
def download_craigslist(page_count = 1, limit = 5):
    ...
    for i in range(page_count):
        ...
        pageNumber = i*40
		#for neightborhoods
        url= "http://www.yelp.com/biz/"+restaurant+"?start="+str(pageNumber)
        print url
...
#inputfile = open("cambridge_restaurantreviews.csv","r")
#spamreader = csv.reader(inputfile)
#for row in spamreader:
#	print row
	
restaurants = ["craigie-on-main-cambridge","salts-restaurant-cambridge","oleana-restaurant-cambridge", "ihop-cambridge"]
#restaurants = ["north-end-fish-market-boston"]
